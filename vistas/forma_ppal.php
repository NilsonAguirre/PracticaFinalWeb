        ...
        <nav class="row navbar navbar-expand-lg navbar-dark bg-success">
              <div class="col-lg-12 collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-row form-inline col-lg-6 col-xl-7">
                  <input class=" form-control-lg text-center border-0 col-lg-11  "  placeholder="¿Que estás buscando?" width="80">
                ...
                <ul class=" navbar-nav col-lg-4 col-xl-3  ">
                  ...
                  <li class="nav-item  ml-auto ">
                        <a > <img src="vistas/iconos/user.png" width="50" height="50" id="imuser" class="img-fluid rounded-circle">
                                        
                    <!-- Button trigger modal -->
                        <button type="button" class="btn btn-success " id="nusuario" data-toggle="modal" data-target="#staticBackdrop">
                          Mi Cuenta
                        </button></a>
                         <?php 
                            include "ingreso.php"
